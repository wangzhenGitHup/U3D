...
namespace WZNet {
    public class WZTool {
        ...
        public static byte[] PackNetMsg<T>(T msg) where T : WZMsg {
        ...
        public static byte[] Serialize<T>(T pkg) where T : WZMsg {
        ...
        public static T DeSerialize<T>(byte[] bs) where T : WZMsg {
